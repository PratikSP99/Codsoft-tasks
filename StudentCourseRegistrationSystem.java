...
public String getTitle (){
  ...
  public String toString() { 
    return "Course Code: "+courseCode+ "\n Title: " +title+ " \nDescription:" + description + "\nSchedule: " + schedule + "\nAvialable Slots:" + availableSlots + "/" + capacity + "\n";
  ...
  class Student {
    ...
    public List<Course> getRegisteredCouses(){
      ...
      public void addCourse (Course course){
       ...
       public static void main(String[]args){
        ...
        StudentCourseRegistrationSystem system = new StudentCourseRegistrationSystem();
         system.addStudent(new Student(1, "pratik palhade"));
         system.addStudent(new Student(2, "Rohit kale"));
          ...
          while (true) {
            ...
            switch(choice) {
              ...
              if (student != null && course != null) {
                student.registeredCourse(course);
                System.out.println("Course registered syccessfully. ");
              }
              else{
                System.out.println("Strudent or course not found.");
              }
              break;
